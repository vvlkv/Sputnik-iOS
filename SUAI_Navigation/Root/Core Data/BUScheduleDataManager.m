...
@interface BUScheduleDataManager () {
...
- (NSPersistentContainer *)dataContainer {
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"BUScheduleDataModel" withExtension:@"momd"];
